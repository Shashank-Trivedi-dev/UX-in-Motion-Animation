## Welcome to  [ # UX in Motion | Animation ]  HTML Code Sections

## Code Link
- Github:       [ Shashank Trivedi Dev ]---------( https://github.com/Shashank-Trivedi-dev/UX-in-Motion-Animation )
- Codepen:      [ @Shashank-Trivedi-Dev ]--------( https://codepen.io/Shashank-Trivedi-Dev/pen/YzdZQgv )
- Replit:       [ @Shashank-Trivedi-Dev ]--------( https://replit.com/@Shashank-Trivedi-Dev/UX-in-Motion-Animation )
- Website Blog: [ ShashankTrivedi.com ]----------( https://shashanktrivedi.com/section/ux-in-motion-animation/ )
